...
bio: '2024.09-2026.02',
text: ` 负责建筑方案全流程设计、AI 辅助创意迭代、效果图表达、模型搭建、图纸绘制及景观一体化设计；参与前期踏勘、方案策划、汇报沟通与项目管理，跨界拓展雕塑装置、展览空间、大地艺术设计。深度参与浮梁和美乡村、惠州产业更新、环两山建筑艺术展等落地项目，负责概念方案、扩初深化、跨专业协同、现场巡检与落地验收；参与冰岛可再生能源研究中心国际竞赛并获荣誉提名，探索建筑与游戏、沉浸式空间跨界创新。<br>
<br>
 AIGC 建筑与数字内容全链路工作流搭建:<br>
 1、从零搭建 ComfyUI 本地私有化 AI 生产底座，独立完成建筑专属 LoRA 数据集标注、模型训练、参数迭代调优，实现建筑效果图风格、构图、细节的高度统一与精准可控。<br>
 2、挖掘 ComfyUI 动态生成能力，业务范围从静态建筑渲染，延伸至像素动画、游戏场景资产、2D 动画素材的批量自动化批量产出，打通静态→动态内容生产全链路。<br>
 3、落地 Lovart 等新一代 AI 智能 Agent 工具，搭建免重复手动调试的自动化批量出图、智能方案快速迭代工作流，完整闭环「文字 prompt 解析→智能多方案生成→标准化成品交付」完整链路。<br>
 4、横向拓展全品类 AIGC 内容制作能力，熟练完成动漫混剪、电商商业广告视觉物料、AI 短剧镜头画面与成片素材全流程创作，精通 AI 镜头运镜、人物画面一致性、成片节奏与叙事优化。<br>
 5、掌握 Vibe Coding 自然语言驱动快速开发能力，无需深度手写代码，通过 AI 编程体快速完成个人作品集展示网站的全栈搭建、页面 UI 美化、AI 作品 / 项目案例在线陈列、响应式适配与线上部署，实现个人成果线上可视化展示。<br>
<br>
 浮梁县茶源和美乡村建设项目:<br>
 1、县域乡村整体更新类落地项目，覆盖乡村民居改造、公共空间、景观节点整体提升，助力乡村文旅产业升级。<br>
 2、负责实地场地踏勘、用户需求梳理、方案平面优化、整体空间效果把控。<br>
 3、完成全套方案文本编制、Rhino 模型搭建、D5效果图绘制、Stable diffusion 模型训练，CAD 扩初图纸绘制，对接结构、水电等多专业协同配合施工图深化。<br>
 4、运用 Lovart 等 AI Agent 工具搭建自动化效果图出图链路，实现设计方案一键多风格、多场景快速渲染，高效对接甲方多轮修改需求。<br>
<br>
 惠州环两山建筑艺术计划「策城记」展览空间设计:<br>
 1、配合策展整体主题，完成本次建筑艺术展的整体空间布局、参观动线规划、展陈模块分区、视觉氛围一体化设计，平衡专业展示性与公众观展体验。<br>
 2、负责展场平面优化、立面造型、展墙结构全套方案设计，协调 CAD 施工图纸、SU/Rhino 空间模型与落地尺寸规范。<br>
<br>
 古榕文学村-雕塑设计:<br>
 1、为惠州市龙门县麻榨镇“星桃甜葛”产业配套基础设施建设项目-中心村片区设计入口主题雕塑、大地艺术景观装置，打造园区地标与打卡视觉核心。<br>
 2、独立完成雕塑方案概念、造型设计、尺寸推敲、材料选品，协调结构施工图推进项目。<br>
 3、全程跟进工厂生产、巡检，协调解决施工偏差与现场调整问题。<br>
<br>
 斐济大地艺术发电机计划国际艺术方案:<br>
 1、面向全球征集的跨国大地艺术 + 新能源主题艺术方案，聚焦可持续能源、大地景观与公共艺术跨界融合。<br>
 2、负责整体艺术概念、场地介入策略、能源系统逻辑与空间形态完整设计。<br>
<br>
 冰岛可再生能源研究中心国际建筑设计竞赛:<br>
 1、本项目为全球公开国际建筑设计竞赛，围绕可再生能源与低碳生态建筑理念，完成研究中心整体方案概念设计与空间体系规划。<br>
 2、主导全流程方案概念推演、场地规划、功能流线与低碳建筑策略落地，全程独立完成方案逻辑搭建与空间创新。<br>
 3、输出全套竞赛汇报文本、分析图纸与最终展示版面。`,
    },
    {
