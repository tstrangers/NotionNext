...
title: 'AIGC建筑与数字内容全链路工作流搭建 | 独立设计师',
      bio: '2026.02-至今',
      text: '1、从零搭建 ComfyUI 本地私有化 AI 生产底座，独立完成建筑专属 LoRA 数据集标注、模型训练、参数迭代调优，实现建筑效果图风格、构图、细节的高度统一与精准可控。'
      text: '2、挖掘 ComfyUI 动态生成能力，业务范围从静态建筑渲染，延伸至像素动画、游戏场景资产、2D 动画素材的批量自动化批量产出，打通静态→动态内容生产全链路。'
      text: '3、落地 Lovart 等新一代 AI 智能 Agent 工具，搭建免重复手动调试的自动化批量出图、智能方案快速迭代工作流，完整闭环「文字 prompt 解析→智能多方案生成→标准化成品交付」完整链路。'
      text: '4、横向拓展全品类 AIGC 内容制作能力，熟练完成动漫混剪、电商商业广告视觉物料、AI 短剧镜头画面与成片素材全流程创作，精通 AI 镜头运镜、人物画面一致性、成片节奏与叙事优化。'
      text: '5、掌握 Vibe Coding 自然语言驱动快速开发能力，无需深度手写代码，通过 AI 编程体快速完成个人作品集展示网站的全栈搭建、页面 UI 美化、AI 作品 / 项目案例在线陈列、响应式适配与线上部署，实现个人成果线上可视化展示。'
    },
    {
